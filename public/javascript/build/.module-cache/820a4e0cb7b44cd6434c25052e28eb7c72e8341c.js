...
var AverageData = React.createClass({displayName: 'AverageData',
            ...
            return (
              React.DOM.li({key: i, id: i}, 
                React.DOM.div({onClick: this.startEdit.bind(null,i), className: visibles[i]}, 
                  React.DOM.span(null, item.value), 
  ...
  var AverageBox = React.createClass({displayName: 'AverageBox',
    ...
    startEdit: function(index, el) {
      ...
      var value = this.state.evals[index].value;
      this.setState({
        indexEdit: index,
        visibles : visibles
      });
    ...
    stopEdit: function(newValue){
      ...
      evaluations[index].value =  newValue;
    ...
    addEvaluation: function() {
      ...
      evaluations = evaluations.concat(newEval);
      this.setState({
        evals: evaluations,
        visibles: visibles
      });
...
GradeBox = React.createClass({displayName: 'GradeBox',
    getInitialState: function() {
      return {data: this.props.data};
    },
    render: function() {
